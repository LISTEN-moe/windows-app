namespace ListenMoeClient
{
	partial class FormSettings
	{
		...
		private void InitializeComponent()
		{
            ...
            this.tabControl.Controls.Add(this.tpSound);
            ...
            this.tpSound.TabIndex = 5;
            this.tpSound.Text = "Sound";
            ...
            this.numericVolumeStep.Value = new decimal(new int[] {
            5,
            0,
            0,
            0});
            this.numericVolumeStep.ValueChanged += new System.EventHandler(this.numericVolumeStep_ValueChanged);
            // 
            // lblVolStep
            // 
            ...
            this.panelTwoFactorAuth.ResumeLayout(false);
            this.panelTwoFactorAuth.PerformLayout();
